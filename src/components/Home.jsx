    ...
    className= "h-screen w-full bg-gradient-to-b from-black via-black to-gray-800 ">
     ...
     justify-center h-full px-4 md:flex-row">
        <div className= "flex flex-col justify-center h-full">
            ...
            I have 6 years of experience in Management. 
            I earned my certificate in web development from the University of Kansas, learning the principles of HTML, CSS, JavaScript, React, MySQL, and multiple other technologies.
            </p>
            <div>
